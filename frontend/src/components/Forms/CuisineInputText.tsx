function CuisineInputText({
  ...
  return (
    <>
      <label
        className={`relative my-4 block rounded-md border border-gray-200 shadow-sm focus-within:border-blue-600 focus-within:ring-1 focus-within:ring-blue-600 ${classNames} ${
...
export default CuisineInputText;
