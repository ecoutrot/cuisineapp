      ...
      {item.options.length > 0 && (
        <>
          {formatGroupLabel ? (
            ...
            <div className={classNames?.listGroupLabel ? classNames.listGroupLabel : "cursor-default select-none truncate py-2 pr-2 font-bold text-gray-700"}>{item.label}</div>
          )}
